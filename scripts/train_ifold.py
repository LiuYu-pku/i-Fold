...
from ifold.config import model_config
from ifold.data.data_modules import OpenFoldDataModule, OpenFoldMultimerDataModule
from ifold.model.model import AlphaFold
from ifold.model.torchscript import script_preset_
from ifold.np import residue_constants
from ifold.utils.argparse_utils import remove_arguments
from ifold.utils.callbacks import (
    EarlyStoppingVerbose,
)
from ifold.utils.exponential_moving_average import ExponentialMovingAverage
from ifold.utils.loss import AlphaFoldLoss, lddt_ca
from ifold.utils.lr_schedulers import AlphaFoldLRScheduler
from ifold.utils.multi_chain_permutation import multi_chain_permutation_align
from ifold.utils.superimposition import superimpose
from ifold.utils.tensor_utils import tensor_tree_map
from ifold.utils.validation_metrics import (
    drmsd,
    gdt_ts,
    gdt_ha,
)
from ifold.utils.import_weights import (
    import_jax_weights_,
    import_ifold_weights_
)
from ifold.utils.logger import PerformanceLoggingCallback
...
def main(args):
    ...
    if args.resume_from_ckpt:
        if args.resume_model_weights_only:
            ...
            if 'module' in sd:
                ...
                import_ifold_weights_(model=model_module, state_dict=sd)
    ...
    if(args.deepspeed_config_path is not None):
        ...
        if(args.wandb and is_rank_zero):
            ...
            wdb_logger.experiment.save("ifold/config.py")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--train_epoch_len", type=int, default=20000,
        help=(
    ...
    trainer_group.add_argument(
        "--log_every_n_steps", type=int, default=5,
    )
    trainer_group.add_argument(
