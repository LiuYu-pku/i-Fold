...
from ifold.data import templates, feature_pipeline, data_pipeline
from ifold.data.tools import hhsearch, hmmsearch
from ifold.np import protein
from ifold.utils.script_utils import (load_models_from_command_line, parse_fasta, run_model,
                                         prep_output, relax_protein)
from ifold.utils.tensor_utils import tensor_tree_map
from ifold.utils.trace_utils import (
...
def main(args):
    ...
    if is_multimer and args.ifold_checkpoint_path:
        raise ValueError(
            '`ifold_checkpoint_path` was specified, but no OpenFold checkpoints are available for multimer mode')

    model_generator = load_models_from_command_line(
        config,
        args.model_device,
        args.ifold_checkpoint_path,
        args.jax_param_path,
        args.output_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="""Name of a model config preset defined in ifold/config.py"""
    )
    parser.add_argument(
        "--jax_param_path", type=str, default=None,
        help="""Path to JAX model parameters. If None, and ifold_checkpoint_path
             is also None, parameters are selected automatically according to 
             the model name from ifold/resources/params"""
    )
    parser.add_argument(
        "--ifold_checkpoint_path", type=str, default=None,
    ...
    if args.jax_param_path is None and args.ifold_checkpoint_path is None:
        args.jax_param_path = os.path.join(
            "ifold", "resources", "params",
